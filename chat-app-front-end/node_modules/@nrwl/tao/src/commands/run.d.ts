...
import { ExecutorContext, WorkspaceConfiguration } from '../shared/workspace';
...
export declare function validateProject(workspace: WorkspaceConfiguration, projectName: string): void;
/**
